...
export default function Sidebar({ side, panels }: SidebarProps) {
    ...
    return (
        <aside
            className={`sidebar-${side} sidebar-slide page-fade-in fixed top-[var(--topnav-height)] ${side}-0 z-30 flex h-[calc(100vh-var(--topnav-height))] flex-col ${side === 'left' ? 'w-[var(--sw-l)]' : 'w-[var(--sw-r)]'} ${
